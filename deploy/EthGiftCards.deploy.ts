...
const func: DeployFunction = async (hre: HardhatRuntimeEnvironment) => {
  ...
  await deploy("EthGiftCards", {
    ...
    args: [
        ...
        "NF-ETH",
        [
          '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><style>.base { fill: black; font-family: courier; font-size: 11px; }</style><rect width="100%" height="100%" fill="white" /><text x="10" y="20" class="base">value: ',
